...
namespace BudgetingService.Migrations
{
    ...
    [Migration("20250227115425_InitBudgetMig")]
    partial class InitBudgetMig
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BudgetingService.Models.Budget", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PeriodEnd = new DateTime(2025, 3, 31, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PeriodStart = new DateTime(2025, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PlannedAmount = 500,
                            UserId = 1L,
                            WarningThreshold = 80
                        },
                        new
                        {
                            ...
                            PeriodStart = new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            PlannedAmount = 2000,
                            UserId = 2L,
                            WarningThreshold = 90
                        });
